...
HD_PWD='/home/miguelan/Escritorio/dsd/practica3/practica3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Manager0s1sPL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Manager0s1sPL.tcl -notrace
