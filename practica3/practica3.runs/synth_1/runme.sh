...
HD_PWD='/home/miguelan/Escritorio/dsd/practica3/practica3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Manager0s1sPL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Manager0s1sPL.tcl
